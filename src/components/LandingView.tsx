...
export const LandingView: React.FC<LandingViewProps> = ({
  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center px-4 py-12 sm:py-20 max-w-5xl mx-auto w-full text-center">
      {/* Hero Header */}
      <h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-[#0f172a] tracking-tight leading-[1.2] max-w-3xl">
        Understand your symptoms <br className="hidden sm:inline" />
      ...
      <p className="mt-4 sm:mt-6 text-slate-500 text-sm sm:text-base md:text-lg max-w-2xl leading-relaxed font-normal">
        A transparent symptom assessment experience that demonstrates <br className="hidden sm:inline" />
        how a separate medical rule engine can explain its simulated guidance.
      </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl w-full mt-16 text-left">
        ...
        <div className="bg-white rounded-2xl p-6 sm:p-7 border border-slate-100 shadow-[0_2px_12px_-3px_rgba(15,23,42,0.06)] flex flex-col justify-between">
          <div>
            ...
            <p className="text-xs sm:text-sm text-slate-500 leading-relaxed">
              Choose from clear, categorized options in a touch-friendly assessment.
            </p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl p-6 sm:p-7 border border-slate-100 shadow-[0_2px_12px_-3px_rgba(15,23,42,0.06)] flex flex-col justify-between">
          <div>
            ...
            <p className="text-xs sm:text-sm text-slate-500 leading-relaxed">
              Confirm selected symptoms before viewing a simulated triage outcome.
            </p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl p-6 sm:p-7 border border-slate-100 shadow-[0_2px_12px_-3px_rgba(15,23,42,0.06)] flex flex-col justify-between">
          <div>
            ...
            <p className="text-xs sm:text-sm text-slate-500 leading-relaxed">
              Explore simulated facts, triggered rules, and an auditable explanation trail.
            </p>
          </div>
        </div>
      </div>
